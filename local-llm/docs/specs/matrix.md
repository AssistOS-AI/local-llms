...
| [DS004](DS004-on-demand-runners.md) | On-demand Runners | accepted | Runners installed after the image is built: the lock in the image, the verified cache in /data, the runnable copy rebuilt in the container, and the CI install check. |
